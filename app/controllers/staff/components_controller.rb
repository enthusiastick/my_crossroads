class Staff::ComponentsController < ApplicationController
  ...
  def ingredient_params
    params.require(:ingredient).permit(:picture, :name, :grade, :category, :rarity, :process_calcination, :process_concentration, :process_dissolution, :process_extraction, :crafting, :ritual_attribute, :ritual_elemental_affinity, :ritual_gender, :ritual_opposite, :staff_notes, profession_ids: [], season_ids: [])
  end
end
