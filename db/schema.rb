...
ActiveRecord::Schema.define(version: 20170511134938) do
  ...
  create_table "stack_ingredients", force: :cascade do |t|
    t.integer "ingredient_id", null: false
    t.integer "quantity", default: 1
    t.integer "stack_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["ingredient_id", "stack_id"], name: "index_stack_ingredients_on_ingredient_id_and_stack_id", unique: true
  end
